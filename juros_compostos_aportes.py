...
def juros_compostos_aportes():
    ...
    prazo, aportes_mensais, taxa_juros = input('''Informe separando com espaços:
...
def juros_compostos():
    ...
    print('Criado por Hugo Paiva.'.rjust(72))
    prazo, aportes_mensais, taxa_juros = input('''Informe separando com espaços:
    Quantos anos deseja manter o dinheiro investido? Qual o valor depositado e juros mensais: '''
        ).split()
    prazo, aportes_mensais, taxa_juros = int(prazo)*12, float(aportes_mensais), float(taxa_juros)
